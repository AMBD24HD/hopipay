                ...
                return (
                  <>
                    ...
                    <div className="relative min-h-0 flex-1 flex flex-col overflow-hidden">
                      ...
                      {/* Floating In-Chat Permanent Scroll Controls (Inside SMS / Message Box) */}
                      <div className="absolute right-3.5 bottom-3.5 z-20 flex items-center gap-1.5 bg-[#07131e]/95 backdrop-blur-md p-1 rounded-2xl border border-emerald-500/40 shadow-2xl">
                        <button
                          type="button"
                          onClick={scrollChatToTop}
                          title="চ্যাটের একদম শুরুতে যান (Scroll to Top)"
                          className="px-2.5 py-1.5 rounded-xl bg-white/10 hover:bg-emerald-600 text-white/90 hover:text-white text-[10px] font-bold flex items-center gap-1 transition active:scale-95 cursor-pointer border border-white/10"
                        >
                          <ChevronUp className="w-3.5 h-3.5 text-emerald-400" />
                          <span>⬆ উপরে (Top)</span>
                        </button>
                        <button
                          type="button"
                          onClick={scrollChatToBottom}
                          title="চ্যাটের একদম শেষে/নতুন মেসেজে যান (Scroll to Bottom)"
                          className="px-2.5 py-1.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white text-[10px] font-black flex items-center gap-1 transition active:scale-95 cursor-pointer shadow-md border border-emerald-400/40"
                        >
          ...
          <form onSubmit={handleSaveSettings} className="ios-glass p-6 sm:p-8 rounded-3xl border border-white/10 space-y-6 bg-[#0c1422]/80">
            ...
            <div className="p-5 rounded-2xl bg-black/40 border border-white/10 space-y-4">
              <div>
                ...
                <p className="text-xs text-white/50 mt-1">
                  ইউজার প্রোফাইলে প্রদর্শিত অপারেশন সময় এবং হেল্পলাইন ও সাপোর্ট নম্বর কনফিগার করুন।
                </p>
              </div>
